...
class Strix():
    def __init__(self):
        ...
        self.weight = "1.8"
        self.art = "None"
        self.created = "ТУ 22.96.89-001-03009823-2017"
        self.barcode = QImage("6.jpeg")

    def change_text(self, str):
        self.text = str

    def change_part(self, str):
        self.part = str
    ...
    def change_weight(self, str):
        self.weight = str

    def change_art(self, str):
        self.art = str

    def change_created(self, str):
        self.created = str
...
class MyWin(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.label.setPixmap(QPixmap.fromImage(self.builder()))
        # Actions
        # self.print.clicked.connect()
    ...
    def builder(self):
        ...
        img = QImage(self.newcode.background_image)
        painter.drawImage(0, 0, img)
        painter.setFont(QFont("Arial", 30))

        painter.drawText(235, 315, '{:<11}'.format(self.newcode.text))
        painter.drawText(235, 375, '{:<11}'.format("d"))
        painter.drawText(235, 440, '{:<11}'.format ("f"))
        painter.drawText(235, 500, '{:<11}'.format("f"))
        painter.drawText(235, 563, '{:<11}'.format("f"))
        painter.end()
        self.label.setPixmap(QPixmap.fromImage(result_img))
        return result_img
